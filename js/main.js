...
const CONSOLES = [
  ...
  },
  {
    ...
    manufacturer: '任天堂 (Nintendo)',
    year: 1996,
    description: '1996年6月23日に任天堂から発売された家庭用ゲーム機。3D空間の自由な移動を可能にした3Dスティックを搭載し、「スーパーマリオ64」や「ゼルダの伝説 時のオカリナ」など、後の3Dゲームの基準となる名作を生み出した。',
    trivia: [
      'コントローラーの中心にある「3Dスティック」は、アナログ入力で3D空間を自在に移動できる画期的な発明だった。',
      '標準で4つのコントローラー端子を備え、スマブラやマリオカートなどのパーティゲームが大流行した。',
      'CD-ROM全盛期にカセット（ROMカートリッジ）を採用。ロード時間がほぼ無く、衝撃にも強かった。'
    ],
    model: 'models/05_Nintendo64.glb',
  },
  {
    id: 'megadrive',
    name: 'メガドライブ',
    nameEn: 'Mega Drive / Genesis',
    manufacturer: 'セガ (SEGA)',
    year: 1988,
    description: '1988年10月29日にセガから発売された16ビット家庭用ゲーム機。北米では「Genesis」として発売され、「ソニック・ザ・ヘッジホッグ」の大ヒットにより爆発的な普及を遂げた。',
    trivia: [
      '本体に金色の文字で「16-BIT」と大きく刻まれ、当時の最先端スペックであることを強烈にアピールしていた。',
      'メガCDやスーパー32Xなど、後から拡張機器を合体させて性能をアップさせるというロマン溢れる仕様（メガドラタワー）で有名。',
      'アーケードゲームに近いスピード感のあるタイトルが多く、独自の熱狂的なファン層を築き上げた。'
    ],
    model: 'models/06_MegaDrive.glb',
  },
  {
    id: 'pcengine',
    name: 'PCエンジン',
    nameEn: 'PC Engine / TurboGrafx-16',
    manufacturer: 'NECホームエレクトロニクス',
    year: 1987,
    description: '1987年10月30日にNECとハドソンが共同開発して発売されたゲーム機。コンパクトなボディながら強力なスプライト表示能力を持ち、アーケードゲームの完全移植などでコアなゲーマーを魅了した。',
    trivia: [
      '「HuCARD」というクレジットカードサイズの極薄ROMメディアを採用し、本体の小型化に貢献した。',
      '世界で初めてゲーム機としてCD-ROMドライブ（CD-ROM²）を導入。大容量によるアニメーションや生演奏BGMを実現した。',
      '後に「PCエンジンGT」という携帯型が発売され、据え置き機と全く同じソフトが外で遊べるという画期的な体験を提供した。'
    ],
    model: 'models/06_PCEngine.glb',
  }
];
